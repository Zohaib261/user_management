...
const LoginVerify = React.lazy(() => import('./views/pages/login/LoginVerify'));
      ...
      <HashRouter>
          <React.Suspense fallback={loading}>
            <Switch>
              ...
              <Route exact path="/adminDashboard" name="Dashboard" render={props => <BasicDashboard {...props}/>} />
              
              <Route exact path="/loginVeriy" name="Login Verify" render={props => <LoginVerify {...props}/>} />
